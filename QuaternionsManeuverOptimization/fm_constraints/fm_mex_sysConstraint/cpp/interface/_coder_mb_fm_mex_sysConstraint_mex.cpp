...
//
// _coder_mb_fm_mex_sysConstraint_mex.cpp
//
...
void mexFunction(int32_T nlhs, mxArray *plhs[], int32_T nrhs,
                 const mxArray *prhs[])
{
  mexAtExit(&mb_fm_mex_sysConstraint_atexit);
  // Module initialization.
  mb_fm_mex_sysConstraint_initialize();
  try {
    emlrtShouldCleanupOnError((emlrtCTX *)emlrtRootTLSGlobal, false);
    // Dispatch the entry-point.
    unsafe_mb_fm_mex_sysConstraint_mexFunction(nlhs, plhs, nrhs, prhs);
    // Module termination.
                                                ...
                                                const mxArray *prhs[3])
{
  ...
  // Call the function.
  mb_fm_mex_sysConstraint_api(prhs, nlhs, outputs);
...
// End of code generation (_coder_mb_fm_mex_sysConstraint_mex.cpp)
