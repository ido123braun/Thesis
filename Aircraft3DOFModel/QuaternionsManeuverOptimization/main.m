...
rfmin_E=[-inf; -inf; -25000*0.3048]; % Minimum Terminal Airplane Radius in Earth Coordinates [m]
rfmax_E=[inf; inf; -25000*0.3048]; % Maximum Terminal Airplane Radius in Earth Coordinates [m]
