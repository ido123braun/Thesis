// Call Function generated automatically on 30-Jan-2023 18:38:48
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) try {
    ...
    if (nrhs == 0 && nlhs == 0) {
        ...
        mexPrintf("- Date:                30-Jan-2023 18:38:48\n");
        ...
        mxSetField(struct_info, 0, info_names[0], mxCreateString("30-Jan-2023 18:38:48"));
