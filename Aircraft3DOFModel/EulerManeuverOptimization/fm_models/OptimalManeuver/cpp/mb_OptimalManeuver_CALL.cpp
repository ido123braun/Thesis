// Call Function generated automatically on 26-Jan-2023 17:14:30
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) try {
    ...
    if (nrhs == 0 && nlhs == 0) {
        ...
        mexPrintf("- Date:                26-Jan-2023 17:14:30\n");
        ...
        mxSetField(struct_info, 0, info_names[0], mxCreateString("26-Jan-2023 17:14:30"));
